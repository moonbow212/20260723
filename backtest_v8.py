...
# ============ 4. 打印结果 ============
print("="*100)
print("MA20轮动策略 V8 回测结果（八指数轮动+国债避险，科创50仅近5/3/1年参与）")
print("="*100)
...
with open('C:/Users/wbl/WorkBuddy/2026-07-20-20-22-46/backtest_v8_data.json','w',encoding='utf-8') as f:
    json.dump(output, f, ensure_ascii=False)
print("\n数据已导出到 backtest_v8_data.json")
