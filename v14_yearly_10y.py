# -*- coding: utf-8 -*-
"""V14(5%/4%)近10年逐年持仓占比及年化收益统计
标的池: 上证50、创业板50、纳斯达克100、沪深300、中证500、中证1000、标普500 + 国债 (近10年全程可用)
"""
import pandas as pd
import numpy as np
import json
...
files = {
    ...
    7: find_file('标普500'), 9: find_file('国债'),
}
names = {1:'上证50', 2:'创业板50', 3:'纳斯达克100', 4:'沪深300',
         5:'中证500', 6:'中证1000', 7:'标普500', 9:'国债'}
...
print(f"近10年: {start_date.date()} ~ {last_date.date()}")
...
print("\n" + "="*150)
print(f"近10年整体: V14 {total_v14*100:.2f}%, V8 {total_v8*100:.2f}%, 超额 {(total_v14-total_v8)*100:+.2f}%")
print(f"V14年化: {(1+total_v14)**(1/10)-1:.4f}, V8年化: {(1+total_v8)**(1/10)-1:.4f}")
...
output = {
    ...
    'ann_v14': float((1+total_v14)**(1/10)-1),
    'ann_v8': float((1+total_v8)**(1/10)-1),
    'yearly': yearly_data,
...
with open('C:/Users/wbl/WorkBuddy/2026-07-20-20-22-46/v14_yearly_10y.json', 'w', encoding='utf-8') as f:
    json.dump(output, f, ensure_ascii=False, indent=2)
print("\n数据已保存到 v14_yearly_10y.json")
